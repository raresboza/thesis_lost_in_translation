...
class MRR(BaseMetric):
    ...
    def eval_user_metric(self):
        ...
        """
        user_mrr={u: MRR.__user_mrr(u_r, self._cutoff, self._relevance.get_user_rel(u))
        ...
        if Settings.current_file != -1:
            ...
            pd.Series(user_mrr).reset_index().to_csv(rf"{save_dir}\mrr_{self._cutoff}.tsv", sep="\t", index=False, header=["user", "value"])
